...
const initialDraft: ApplicationFormValues = {
  amount: 250_000, months: 48, firstName: '', lastName: '', email: '', phone: '', employmentType: 'employee', monthlyIncome: 45_000, monthlyExpenses: 20_000
};
...
export const useApplicationStore = create<ApplicationStore>()(
  persist(
    ...
    { name: 'loanflow-application-draft', version: 1 }
  )
);
