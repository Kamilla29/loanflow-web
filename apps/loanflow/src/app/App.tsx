  ...
  return (
    <main id="main-content" className="page-shell home-page">
      <section className="hero">
        <div className="hero__content">
          ...
          <p className="hero__lead">
            LoanFlow is a fictional fintech application built to demonstrate reusable frontend
            architecture, complex form handling, resilient UI states and automated quality practices.
          </p>
          <div className="hero__actions">
            <a className="lf-button lf-button--primary" href="#calculator">
              Calculate a loan
            </a>
            <Link className="lf-button lf-button--secondary" to="/apply">
      ...
      <section className="architecture-grid section-block" aria-label="Project architecture highlights">
        <article>
          <span>01</span>
          <h2>Feature-oriented UI</h2>
          <p>Routes orchestrate the product journey while reusable primitives stay in an Nx UI library.</p>
        </article>
        <article>
          <span>02</span>
          <h2>Typed domain logic</h2>
          <p>Calculations, affordability rules and validation are isolated from presentation and unit tested.</p>
        </article>
        <article>
          <span>03</span>
          <h2>Failure-aware UX</h2>
          <p>Persistent drafts, loading states and recoverable API failures are first-class product states.</p>
        </article>
      </section>
    </main>
  );
  ...
  return (
    <div className="app-shell">
      ...
      <footer className="footer">
        ...
        <span>React · TypeScript · Quality engineering</span>
      </footer>
    </div>
  );
}
